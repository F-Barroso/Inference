...
for n_nodes in [60]:
    ...
    for i in range(50):
        ...
        FN = len(DAGt.edges-DAG_w1.edges) #False Negatives
        FP = len(DAG_w1.edges-DAGt.edges) #False Positives
        TP = len(DAGt.edges) - FN #True Positives = P - FN
        TN = (n_nodes*n_nodes - len(DAGt.edges)) - FP #True Negatives = N - FP
        data[0,34] = FP/(n_nodes*n_nodes - len(DAGt.edges)) #FPR = FP/N
        data[0,35] = FN/len(DAGt.edges) #FNR = FN/P
        ...
        TP = len(DAGt.edges) - FN #True Positives = P - FN
        TN = (n_nodes*n_nodes - len(DAGt.edges)) - FP #True Negatives = N - FP
        data[0,37] = FP/(n_nodes*n_nodes - len(DAGt.edges)) #FPR = FP/N
        data[0,38] = FN/len(DAGt.edges) #FNR = FN/P
        ...
        TP = len(DAGt.edges) - FN #True Positives = P - FN
        TN = (n_nodes*n_nodes - len(DAGt.edges)) - FP #True Negatives = N - FP
        data[0,40] = FP/(n_nodes*n_nodes - len(DAGt.edges)) #FPR = FP/N
        data[0,41] = FN/len(DAGt.edges) #FNR = FN/P
        ...
        TP = len(DAGt.edges) - FN #True Positives = P - FN
        TN = (n_nodes*n_nodes - len(DAGt.edges)) - FP #True Negatives = N - FP
        data[0,43] = FP/(n_nodes*n_nodes - len(DAGt.edges)) #FPR = FP/N
        data[0,44] = FN/len(DAGt.edges) #FNR = FN/P
        ...
        f = open("synthmeasuresDense_NOrder_alt.txt", "a+")
        np.savetxt(f,data)
        f.close()
        del data
